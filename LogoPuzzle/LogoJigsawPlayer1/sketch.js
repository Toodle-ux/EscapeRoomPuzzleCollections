...
// client credentials:
let creds = {
  clientID: 'LogoPuzzlePlayer1', // choose whatever name you want
...
function onMessageArrived(message) {
  ...
  if (incoming == "tln0"){
    topLeftNum = 0;
  } else if (incoming == "tln1") {
    topLeftNum = 1;
  } else if (incoming == "tln2") {
    topLeftNum = 2;
  } else if (incoming == "tln3") {
    topLeftNum = 3;
  } else if (incoming == "dln0") {
    downLeftNum = 0;
  } else if (incoming == "dln1") {
    downLeftNum = 1;
  } else if (incoming == "dln2") {
    downLeftNum = 2;
  } else if (incoming == "dln3") {
    downLeftNum = 3;
  } else if (incoming == "dmn0") {
    downMiddleNum = 0;
  } else if (incoming == "dmn1") {
    downMiddleNum = 1;
  } else if (incoming == "dmn2") {
    downMiddleNum = 2;
  } else if (incoming == "dmn3") {
    downMiddleNum = 3;
  }
...
function mousePressed(){
  ...
  if (dist(mouseX, mouseY, width/10*6, height/10) < (width / 30)){
    ...
    sendMqttMessage("trn" + topRightNum);
  }
  ...
  if (dist(mouseX, mouseY, width/10*9, height/10*6) < (width / 30)){
    ...
    sendMqttMessage("drn" + topRightNum);
  }
